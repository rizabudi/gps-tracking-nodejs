...
var adapter = function (device) {
  ...
  this.receive_heartbeat = function (msg_parts) {
    ...
    var data = {
      ...
      'power': this.dex_to_dec(str.substr(2, 4))/100,
      'gsm': this.dex_to_dec(str.substr(6, 2)),
      'alert': '',
    };
  ...
  this.receive_action = function (msg_parts) {
    ...
    var command_content = str.substr(10, parseInt(length_command, 16)*2 - 8);
